...
__ALIGN_BEGIN static uint8_t USBD_CUSTOM_HID_CfgFSDesc[USB_CUSTOM_HID_CONFIG_DESC_SIZ] __ALIGN_END =
        {
                ...
                (uint8_t) CUSTOM_HID_EPIN_SIZE, /* wMaxPacketSize: 2 Byte max */
                ...
                (uint8_t) CUSTOM_HID_EPOUT_SIZE, /* wMaxPacketSize: 2 Bytes max  */
                CUSTOM_HID_EPOUT_SIZE >> 8,
                CUSTOM_HID_FS_BINTERVAL, /* bInterval: Polling Interval */
                /* 41 */
        };
...
__ALIGN_BEGIN static uint8_t USBD_CUSTOM_HID_CfgHSDesc[USB_CUSTOM_HID_CONFIG_DESC_SIZ] __ALIGN_END =
        {
                ...
                0x00,                    /* bAlternateSetting: Alternate setting */
                0x02,                    /* bNumEndpoints */
                0xff,                    /* bInterfaceClass: 用户自定义设备类型 */
                0x00,                    /* bInterfaceSubClass : 1=BOOT, 0=no boot */
                0x00,                    /* nInterfaceProtocol : 0=none, 1=keyboard, 2=mouse */
...
__ALIGN_BEGIN static uint8_t USBD_CUSTOM_HID_OtherSpeedCfgDesc[USB_CUSTOM_HID_CONFIG_DESC_SIZ] __ALIGN_END =
        {
                ...
                CUSTOM_HID_EPIN_ADDR,          /* bEndpointAddress: Endpoint Address (IN) */
                0x02,                          /* bmAttributes: Interrupt endpoint */
                (uint8_t) CUSTOM_HID_EPIN_SIZE, /* wMaxPacketSize: 2 Bytes max */
                CUSTOM_HID_EPOUT_SIZE >> 8,
                CUSTOM_HID_FS_BINTERVAL, /* bInterval: Polling Interval */
                /* 34 */
...
static uint8_t USBD_CUSTOM_HID_Init(USBD_HandleTypeDef *pdev, uint8_t cfgidx)
{
    ...
    /* Open EP IN */
    (void) USBD_LL_OpenEP(pdev, CUSTOM_HID_EPIN_ADDR, USBD_EP_TYPE_BULK,
                          CUSTOM_HID_EPIN_SIZE);

    pdev->ep_in[CUSTOM_HID_EPIN_ADDR & 0xFU].is_used = 1U;

    /* Open EP OUT */
    (void) USBD_LL_OpenEP(pdev, CUSTOM_HID_EPOUT_ADDR, USBD_EP_TYPE_BULK,
